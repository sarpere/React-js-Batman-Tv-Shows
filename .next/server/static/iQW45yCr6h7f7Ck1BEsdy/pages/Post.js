...
class Post extends react__WEBPACK_IMPORTED_MODULE_1__["Component"] {
  render() {
    ...
    return data ? __jsx(_components_MyLayout_js__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"], null, __jsx("h1", null, data.name), __jsx("div", {
...
Post.getInitialProps = async function (context) {
  ...
  const res = await axios__WEBPACK_IMPORTED_MODULE_4___default.a.get(`https://api.tvmaze.com/shows/${id}`);
  const show = await res.data;
  store.dispatch(Object(_store__WEBPACK_IMPORTED_MODULE_5__[/* setTvShowsDetails */ "c"])(id, show));
  return {
    id: id
  };
};
...
const mapDispatchToProps = dispatch => {
  return {
    setTvShowsDetails: Object(redux__WEBPACK_IMPORTED_MODULE_3__["bindActionCreators"])(_store__WEBPACK_IMPORTED_MODULE_5__[/* setTvShowsDetails */ "c"], dispatch)
  };
};
