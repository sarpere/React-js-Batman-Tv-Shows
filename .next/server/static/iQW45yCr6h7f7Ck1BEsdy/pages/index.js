...
function Header() {
  return __jsx("div", {
    ...
    href: "https://github.com/sarpere/React-js-Batman-Tv-Shows"
  }, __jsx("a", {
    style: linkStyle
  }, "Github")));
}
// EXTERNAL MODULE: ./style.sass
var style = __webpack_require__("8YIL");
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return setTvShows; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return setTvShowsDetails; });
...
const setTvShows = payload => dispatch => {
  return dispatch({
    type: actionTypes.SET_TVSHOWS,
    payload: payload
  });
};
const setTvShowsDetails = (Id, payload) => dispatch => {
  return dispatch({
...
/* harmony import */ var _components_MyLayout_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("3Hq7");
...
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("BXF7");
...
class Index extends react__WEBPACK_IMPORTED_MODULE_3__["Component"] {
  render() {
    return __jsx(_components_MyLayout_js__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"], null, __jsx("h1", null, "Batman TV Shows"), __jsx("ul", null, this.props.tvShows && this.props.tvShows.map(({
      show
    }) => __jsx("li", {
      key: show.id
    }, __jsx("div", {
...
Index.getInitialProps = async function ({
  ...
  const res = await axios__WEBPACK_IMPORTED_MODULE_1___default.a.get('https://api.tvmaze.com/search/shows?q=batman');
  const data = await res.data;
  store.dispatch(Object(_store__WEBPACK_IMPORTED_MODULE_6__[/* setTvShows */ "b"])(data));
  return {
    data: data
  };
};
...
const mapDispatchToProps = dispatch => {
  return {
    setTvShows: Object(redux__WEBPACK_IMPORTED_MODULE_5__["bindActionCreators"])(_store__WEBPACK_IMPORTED_MODULE_6__[/* setTvShows */ "b"], dispatch)
  };
};
